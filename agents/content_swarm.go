...
func ContentFactory() []SpecialistAgent {
	return CreateContentSwarm("content")
}

func SpiralContentFactory() []SpecialistAgent {
	return CreateContentSwarm("spiral_content")
}

func CreateContentSwarm(vertical string) []SpecialistAgent {
	specialties := []string{
